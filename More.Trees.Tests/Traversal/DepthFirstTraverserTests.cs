...
namespace More.Trees.Tests.Traversal
{
    ...
    public class DepthFirstTraverserTests
    {
        ...
        public void Traverse_BinaryTree_WhenSingleNode_ShouldReturnSingleNode()
        {
            ...
            var traverser = new DepthFirstTraverser<TestData>();
        ...
        [Test]
        public void Traverse_BinaryTree_WhenMultipleNodes_ShouldReturnNodesInDfsOrder()
        {
            // Arrange
            var root = new BinaryTreeNode<TestData>(new TestData { Value = 1 });
        ...
        [Test]
        public void Traverse_GeneralTree_WhenMultipleNodes_ShouldReturnNodesInDfsOrder()
        {
            // Arrange
            var root = new TreeNode<TestData>(new TestData { Value = 1 });
